...
const SettingsPage: React.FC = () => {
  ...
  const [activeSection, setActiveSection] = useState(() => {
    ...
    return params.has("connected") ? "integrations" : "account";
  });
  ...
  const sectionItems = [
    ...
    { id: "integrations", icon: <Plug className="w-5 h-5" />, label: "Integrations" },
    {
      id: "appearance",
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          <motion.div variants={slideUp} initial="hidden" animate="visible" className="md:col-span-3">
            <GlassCard>
              ...
              {!["about", "integrations"].includes(activeSection) && (
